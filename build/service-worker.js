"use strict";
var precacheConfig = [["/Tomato-potato-time/index.html", "df44777e522d93b142b64d6ae97c5800"], ["/Tomato-potato-time/static/css/main.7311129b.css", "0173fbc2f65a2c2073085f8031787409"], ["/Tomato-potato-time/static/js/main.40b64a97.js", "fd58344fe7a64eaa038220d169af86e4"]]
...
self.addEventListener("fetch", function(t) {
    if ("GET" === t.request.method) {
        ...
        (e = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, r),
        e = urlsToCacheKeys.has(n));
        var a = "/index.html";
        !e && "navigate" === t.request.mode && isPathWhitelisted(["^(?!\\/__).*"], t.request.url) && (n = new URL(a,self.location).toString(),
        e = urlsToCacheKeys.has(n)),
